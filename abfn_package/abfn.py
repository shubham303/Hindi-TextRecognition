...
from abfn_package.util import detect_language, get_character_set_for_lang
...
class ABFN:
    ...
    def tokenize(self, text):
        ...
        if not valid:
            logging.debug("not a valid text label  : {}".format(text))
            raise Exception("invalid text label:", text)
